package com.lh.mapwidget.sample;
...
import com.lh.mapwidget.sample.popup.TextPopup;
...
public class MainActivity extends AppCompatActivity implements OnMapTouchListener, MapEventsListener {
    ...
    public void onTouch(MapWidget v, MapTouchedEvent event) {
        ...
        if (objectTouchEvents.size() == 1) {
            ...
            Toast.makeText(MainActivity.this, "Touched object " + objectId + " on layer" +
